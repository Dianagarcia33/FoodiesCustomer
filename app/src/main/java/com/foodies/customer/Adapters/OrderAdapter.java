...
import com.foodies.customer.Models.OrderModelClass;
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
     ...
     //   String deliver = getDataAdapter1.getDelivery();
      ...
      //  String time = date_time.substring(11,19);
        ...
        holder.menu_item_name.setText(getDataAdapter1.getOrder_name().replaceAll("&amp;", "&"));

        holder.retaurant_name.setText(getDataAdapter1.getRestaurant_name().replaceAll("&amp;", "&"));
